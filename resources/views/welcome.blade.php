                    ...
                    <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="profile-tab">
                        <div style="background-color: white" class="card-body">
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="rasi_social" class="col-md-4 col-form-label text-md-right">{{ __('Raison Social') }}
                                        <span class="text-danger ml-1">*</span>
                                    </label>

                                    <div class="col-md-6">
                                        <input type="text" class="form-control @error('rasi_social') is-invalid @enderror" name="rasi_social" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control @error('tele') is-invalid @enderror" name="tele" required>
