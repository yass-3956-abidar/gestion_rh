    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <button class="btn btn-danger d-flex justify-content-end ">Anulue</button>
                <a href="{{route('paie.apercu')}}" class="btn btn-primary d-flex justify-content-end ">Apercu</a>
            </div>
        </div>
    </div>
</div>
