        ...
        <form id="fromSimul" method="get">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <input id="avance" type="number" min="0" name="avance" value="0" class=" col-md-6 form-control @error('avance') @enderror">
                        @error('avance')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <div class="form-group row">
                        ...
                        <input id="interit" type="number" min="0" value="0" name="interit" class=" col-md-6 form-control @error('interit') @enderror">
                        @error('interit')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row">
                <div id="addDeleteImpo" class="col-md-6">
                    <a id="btnImosable" class=" btn btn-outline-info">Ajouter une prime<i class="fas ml-2  fa-plus-square"></i></a>
