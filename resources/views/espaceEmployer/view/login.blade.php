            ...
            <div class="card-body">
                ...
                <form class="text-center" action="{{route('espaceEmployer.store')}}" method="POST">
                  @csrf
                    ...
                    <!-- Name -->
                    <input type="text" id="defaultSubscriptionFormPassword" name="nom" class="form-control mb-4" value="{{old('nom')}}" placeholder="Nom Employer">

                    <!-- Email -->
                    <input type="text" name="matricule" id="defaultSubscriptionFormEmail" class="form-control mb-4" value="{{old('matricule')}}" placeholder="Matricule">
